...
namespace Space
{
	SPACE_API tstring toTs(const std::string &in);
	SPACE_API tstring toTs(const std::wstring &in);
	SPACE_API std::wstring str2wstr(const std::string &in);
	SPACE_API std::wstring str2wstr(const std::wstring &in);
	SPACE_API std::string wstr2str(const std::wstring &in);
	SPACE_API std::string wstr2str(const std::string &in);
	
	SPACE_API int32 GetVarArgsW(wchar_t* dest, uint32 size, const wchar_t* fmt, va_list args);
	SPACE_API int32 GetVarArgsA(char* dest, uint32 size, const char* fmt, va_list args);
...
#	define ALIGNMENT 16
	...
	class SPACE_API PropertyManager
	{
	public:
	...
	template<>
	class SPACE_API Property<float> : public PropertyBase, public Variant<float>
	{
	public:
	...
	template<>
	class SPACE_API Property<Float2> : public PropertyBase, public Variant<Float2>
	{
	public:
	...
	template<>
	class SPACE_API Property<Float3> : public PropertyBase, public Variant<Float3>
	{
	public:
	...
	template<>
	class SPACE_API Property<Float4> : public PropertyBase, public Variant<Float4>
	{
	public:
	...
	template<>
	class SPACE_API Property<Float4x4> : public PropertyBase, public Variant<Float4x4>
	{
	public:
	...
	template<>
	class SPACE_API Property<tstring> : public PropertyBase, public Variant<tstring>
	{
	public:
	...
	template<>
	class SPACE_API Property<Name> : public PropertyBase, public Variant<Name>
	{
	public:
	...
	template<>
	class SPACE_API Property<int> : public PropertyBase, public Variant<int>
	{
	public:
	...
	template<>
	class SPACE_API Property<bool> : public PropertyBase, public Variant<bool>
	{
	public:
...
#define DEF_OBJECT_PROPERTY(name,objecttype, category,defaultValue) \
	...
	SPACE_API std::string GetAssetsPath();

	SPACE_API int32 GetFormatSize(DataFormat format);
	SPACE_API int32 GetElementSize(VertexElemType type);
	
	SPACE_API char const* GetSemanticName(ElemSemantic semantic);
