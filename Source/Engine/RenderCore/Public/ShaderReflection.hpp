...
namespace Space
{
	namespace Render {
		...
		{
			template<class Impl>
			class RENDERCORE_API ShaderReflectionImpl :
			...
			class RENDERCORE_API ShaderReflectionConstantBuffer : private Uncopyable
			{
			public:
			...
			template<class Impl>			
			class RENDERCORE_API ShaderReflectionVariableImpl : 
				public SharedPtrObject<Impl>,
				public PImpl<Impl>
			{
			public:
			...
			class RENDERCORE_API ShaderReflectionBindResource : private Uncopyable
			{
			public:
